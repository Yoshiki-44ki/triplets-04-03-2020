 ...
 * Yoshiki Harada
 *26/02/2020
 * This program makes a random poem 
 */
...
public class TripletsJava {
    ...
    rhymingNouns.add("home");
    rhymingNouns.add("tree");
    rhymingNouns.add("chair ");
    rhymingNouns.add("a chocolate shop");
    ...
    //Display the poem
    System.out.println("There is " + noun + " " + verb1 + " a " + 
      rhymingNoun1 + "\n" + "And then " + verb2 + 
      " it in the " + rhymingNoun2 + "\n At the same time " + verb3 + 
            "in the" + rhymingNoun3);
    }
